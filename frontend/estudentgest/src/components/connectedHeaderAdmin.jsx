      ...
      <>
               <nav className="navbar navbar-expand-lg navbar-light bg-light fixed-top px-4" style={{zIndex:'90'}}>
                <a className="navbar-brand d-flex align-items-center bi-person-circle" href="#/">
                  <h6  className="fw-bold " style={{marginLeft: '10px'}}> <span className="fw-normal">Bonjour! </span> {UserNom} {UserPrenom}</h6>
                </a>
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                  <ul className="navbar-nav ms-auto">
                    <li className="nav-item mx-2">
                      <a className="nav-link btn bi-house" href="/administration"> Dashboard</a>
                    </li>
                    <li className="nav-item mx-2">
                      <a className="nav-link btn bi-tools" href="/ApplyGestAdmin"> Gérer les Demandes</a>
                    </li>
